...
set sql_safe_updates = 0;
Update human_resource set hire_date = str_to_date(hire_date, '%m/%d/%Y');
Set sql_safe_updates = 1;
...
-- birthdays/hire dates of employees

select first_name, last_name, birthdate from human_resource;

select first_name, last_name, hire_date from human_resource;
